...
@Deprecated public class StarHackerIntel extends BaseIntelPlugin {
/*
    ...
    public StarHackerIntel(String action, CommoditySpecAPI commodity, MarketAPI market, IntelTracker tracker,
                           Price priceProvider) {
        this.action = action;
